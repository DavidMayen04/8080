...
- **3 programas de ejemplo** cargables desde el editor (suma, riesgo de datos con `FWAIT`, excepciones). Los demás programas del capítulo 6 de `INSTRUCTIONS.md` se pueden pegar en el editor.
